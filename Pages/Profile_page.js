...
exports.Profile_page = class Profile_page {
  constructor(page) {
    ...
    this.Toast_message = page.locator(
      "div[class='SubmitToast_toast__QpmQU undefined'] p"
    );
    ...
    this.History_Cash =
      "(//p[@class='transaction-history-desktop_navItem__NFbte '])[1]";
...
async Pincode_input(newPinCode) {
  ...
  if (currentValue.length === 0) {
    ...
    await this.e_pinCode.fill(''); 
    await this.e_pinCode.fill(newPinCode);
    console.log("Pin code was already filled, replaced with new value");
  }
}
