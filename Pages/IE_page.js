...
exports.IE_page = class IE_page{
    ...
    constructor(page){
        ...
        // TOP buttons.
    this.IE_botton = "ul[class='flex gap-[56px]'] a[class='bold-16 cursor-pointer']";
    ...
    this.Earn_superj = ".Navbar_superjButton__PVXTb.Navbar_customBtn__skcPE.Navbar_btn11__x9Nbg";
        this.Login = "body > main:nth-child(1) > nav:nth-child(1) > div:nth-child(2) > div:nth-child(2) > ul:nth-child(1) > li:nth-child(2)";
